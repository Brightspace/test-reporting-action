...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(6852); });
    const sso = ssoClient ||
...
exports.GetRoleCredentialsCommand = clientSso.GetRoleCredentialsCommand;
exports.SSOClient = clientSso.SSOClient;
